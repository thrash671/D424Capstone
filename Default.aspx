...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="btnUpdate" runat="server" Text="Update Item" OnClick="btnUpdate_Click" /><br><br>
    ...
    <asp:Button ID="btnTotalActiveCards" runat="server" Text="Display Total Active Items" OnClick="btnTotalActiveCards_Click" />
    <asp:TextBox ID="txtTotalSold" runat="server"></asp:TextBox>
    <asp:Button ID="btnDisplayTotal" runat="server" Text="Display Total Sales" OnClick="btnDisplayTotal_Click" /><br><br>
    ...
    <asp:Button ID="btnDisplaySearch" runat="server" OnClick="btnDisplaySearch_Click" Text="Search for Item" />
    <br><br>
